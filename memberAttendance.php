    ...
    <div class="row">
      ...
      <div class="col-md-9">
        <div class="d-flex justify-content-between align-items-center mb-3">
          <h3>Members Attendance Lists</h3>
        </div>
        <?php
        ...
        <table class="table table-bordered" id="staffTable">
          ...
          <?php
    $cnt=1;
      $dis = mysqli_query($conn,"SELECT * FROM attendance JOIN members ON attendance.member_id=members.member_id JOIN club_services on members.club_id=club_services.club_id JOIN plans on members.plan_id=plans.plan_id");
            ...
            <tr>
                <td class="text-center"><?php echo $cnt;?></td>
                 ...
                 <?php  
                  ...
                  if($sta == 'Present'){
                    ?>
             <td class="btn btn-success btn-sm"><?php echo $rows['status'] ?></td>
                    <?php
                  }
                  else{
                    ?>
                    <td class="btn btn-danger btn-sm"><?php echo $rows['status'] ?></td>
                    <?php
                  }
                 ?>
            </tr>
