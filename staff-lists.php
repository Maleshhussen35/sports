...
<body>
    ...
    <div class="row">
      ...
      <div class="col-md-9">
        ...
        <table class="table table-bordered" id="staffTable">
          ...
          <?php
    $cnt=1;
      $dis = mysqli_query($conn,"select * from staff");
        ...
        ?>
            <tr>
                <td class="text-center"><?php echo $cnt;?></td>
                 ...
                 <td>
    <a class="btn btn-warning btn-sm" href="editstaff.php?staff_id=<?php echo $staff_id; ?>">Edit</a>
  ...
  <div class="modal fade" id="addStaffModal" tabindex="-1" role="dialog" aria-labelledby="addStaffModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form <?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?> method="POST" onsubmit="return validatePhoneNumber()">
  ...
  <div class="form-group">
    ...
    <input type="tel" class="form-control" id="staffPhone" name="phone" required oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0,10)">
