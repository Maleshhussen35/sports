...
if (isset($_GET['staff_id'])) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $phone = trim($_POST['phone']);
            ...
            $updateQuery = mysqli_query($conn, "UPDATE staff SET name = '$name', position = '$position', email = '$email', phone = '$phone' WHERE staff_id = '$staff_id'");
  ...
  <div class="container mt-4">
    ...
    <form method="POST">
      <div class="form-group">
        ...
        <input type="text" class="form-control" id="staffName" name="name" value="<?php echo $staff['name']; ?>" required>
      </div>
      <div class="form-group">
        <label for="staffPosition">Position</label>
        <input type="text" class="form-control" id="staffPosition" name="position" value="<?php echo $staff['position']; ?>" required>
      </div>
      <div class="form-group">
