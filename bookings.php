...
<?php include_once("includes/topbar.php");?>
  ...
  <div class="container-fluid mt-4">
    ...
    $cnt=1;
      $dis = mysqli_query($conn,"select * from members join club_services on members.club_id=club_services.club_id join plans on members.plan_id=plans.plan_id where member_id='$member_id'");
        ...
        ?>
            <tr>
                <td class="text-center"><?php echo $cnt;?></td>
                 ...
                 <td>
    <a class="btn btn-warning btn-sm" href="changeSession.php?member_id=<?php echo $member_id; ?>" onclick="return confirm('You are about to change your session period')">Change Session</a>
</td>
